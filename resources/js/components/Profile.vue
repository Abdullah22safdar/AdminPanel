        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background-image:url('./img/user-background.jpg')">
                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" @change="upadtePicture" name="photo" class="form-input">
                                        </div>
